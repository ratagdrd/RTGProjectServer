...
using System.Net;
    ...
    public int InsertVisitor(Visitor visitor)
    {
        ...
        cmd = CreateInsertVisitorWithStoredProcedure("sp_InsertVisitor", con, visitor);     // create the command
        try
        {
    ...
    private SqlCommand CreateInsertVisitorWithStoredProcedure(String spName, SqlConnection con, Visitor visitor)
    {
        ...
        cmd.Parameters.AddWithValue("@nickName", visitor.NickName);
        cmd.Parameters.AddWithValue("@yearOfBirth", visitor.YearOfBirth);
